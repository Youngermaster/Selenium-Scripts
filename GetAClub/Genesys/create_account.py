...
def create_account(driver):
    ...
    # Year selection
    click_element_by_xpath(
        '/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/mat-calendar-header/div/div/button[1]')
    # Backwards arrow button
    click_element_by_xpath(
        '/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/mat-calendar-header/div/div/button[2]')
    # Selects the year, in this case 2001
    click_element_by_xpath(
        '/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-multi-year-view/table/tbody/tr[3]/td[2]/div[1]')
    # Selects the month, in this case march
    click_element_by_xpath(
        '/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-year-view/table/tbody/tr[2]/td[3]/div[1]')
    # Selects the day, in this case 19
    click_element_by_xpath(
        '/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-month-view/table/tbody/tr[4]/td[2]/div[1]')
    # Clicks submit
    click_element_by_xpath(
