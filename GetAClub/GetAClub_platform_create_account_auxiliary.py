...
signup_button = driver.find_element_by_xpath('/html/body/genesys-root/genesys-landing-page/section/div/div[1]/div/swiper/div/div[1]/div[2]/div/div[3]/button[1]')
signup_button.click()

date_selector = driver.find_element_by_xpath('/html/body/genesys-root/genesys-signup-page/section/div/div[2]/div/form/div/div[1]/input')
date_selector.click()

first_calendar_period = WebDriverWait(driver, 10).until(lambda x: x.find_element_by_class('/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/mat-calendar-header/div/div/button[1]')) 
...
year_selector = driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-multi-year-view/table/tbody/tr[3]/td[2]')
year_selector.click()

month_selector = driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-year-view/table/tbody/tr[2]/td[3]')
month_selector.click()

day_selector = driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/mat-dialog-container/mat-datepicker-content/mat-calendar/div/mat-month-view/table/tbody/tr[4]/td[2]')
day_selector.click()
...
avatar = driver.find_element_by_xpath('/html/body/genesys-root/genesys-signup-page/section/div/div[2]/div/genesys-gallery-form/section/div/div[2]/div[2]/div')
avatar.click()
